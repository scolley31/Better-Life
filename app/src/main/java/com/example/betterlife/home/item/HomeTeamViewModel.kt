        ...
        coroutineScope.launch {
            for (i in _plans.value!!.indices) {
                ...
                Log.d("group","group = $group")
                    ...
                    var completedOne = repository.getCompleted(_plans.value!![i].id, _groups.value!![i].membersID[0])
                    Log.d("completed","completedOne = $completedOne")
                    ...
                    var completedTwo = repository.getCompleted(_plans.value!![i].id, _groups.value!![i].membersID[1])
                    Log.d("completed","completedTwo = $completedTwo")
